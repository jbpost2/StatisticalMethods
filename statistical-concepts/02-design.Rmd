...
To describe the methods for creating a well-designed experiment, we first need to recap some definitions.
...
Reason we need statistics, notice that many of the response values are different.  What is causing them to be different?
...
- Variables unaccounted for (these make up the Experimental Error or Error Variation), controlled vars
