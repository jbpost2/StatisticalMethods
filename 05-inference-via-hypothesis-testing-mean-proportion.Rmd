...
Having identified their response variable, the testers shot 50 projectiles and recorded whether or not the system detected each shot. Table 1 shows these data.
...
It's clear that the system detects these projectiles with a high probability, but 
