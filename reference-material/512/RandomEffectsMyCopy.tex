\begin{center}\large\textbf{Readings: 17.1-17.2}\\
...
\beq{
\bar{Y}_{\bullet\bullet} &=& \frac{1}{N}\sum_{i=1}^t \sum_{j=1}^n Y_{ij} \\
&=& \frac{1}{N}\sum_{i=1}^t \sum_{j=1}^n (\mu + T_i + E_{ij}) \\
&=& \mu + \bar{T}_{\bullet} + \bar{E}_{\bullet\bullet}}
where $\bar{T}_{\bullet}=(T_1 + \cdots + T_t)/t$ and $\bar{E}_{\bullet\bullet}=(\sum \sum E_{ij})/N$,
so that
\beq{
\Var(\bar{Y}_{\bullet\bullet}) &=& \Var(\bar{T}_{\bullet} + \bar{E}_{\bullet\bullet}) \\
