...
Many of these and other GPPs can be taken care of by programming in a notebook environment such as JUPYTER (which can include SAS and R) or R Markdown.  Also using a version control software such as Git and Github is really useful!
